...
def viewDataEntity(request):
    try:
        ...
        # qs_result = view_data_entity.getConfigResult(request)
        # schedules.backend_schedulejob()
        # test = connect_adb.getDataAdb()
...
@login_required
def get_config_result(request):
    try:
        if request.method == 'POST':
            data = view_data_entity.getConfigResult(request)
    except Exception as error:
        print(error)
    return JsonResponse(data,safe=False)
...
def get_description(request):
    try:
        if request.method == 'POST':
            data = view_data_entity.getDescription(request)
    except Exception as error:
        print(error)
    return JsonResponse(data,safe=False)
...
def get_name_list(request):
    try:
        if request.method == 'POST':
            data = view_data_entity.getNameList(request)
    except Exception as error:
        print(error)
    return JsonResponse(data,safe=False)
...
def get_validation_status(request):
    try:
        if request.method == 'POST':
            data = view_data_entity.getValidationStatus(request)
    except Exception as error:
        print(error)
    return JsonResponse(data,safe=False)
...
def get_total_record(request):
    try:
        if request.method == 'POST':
            data = view_data_entity.getTotalRecord(request)
    except Exception as error:
        print(error)
    return JsonResponse(data,safe=False)
...
#     try:
#         if request.method == 'POST':
#             data = view_data_entity.getProduct(request)
#     except Exception as error:
#         print(error)
#     return JsonResponse(data,safe=False)