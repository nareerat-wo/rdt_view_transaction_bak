...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        if aad_auth:
            ...
            #print('aem test attrs_before aad_auth:', attrs_before)
        elif user:
            cstr_parts['UID'] = user
        ...
        retry_count = 0
        need_to_retry = False
        print('aem test connstr:', connstr)
        while conn is None:
            try:
                ...
                print('aem test conn:', conn)
            except Exception as e:
                print('Exception captured during connection:',e)
